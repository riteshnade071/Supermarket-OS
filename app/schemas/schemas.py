...
class LowStockAlert(BaseModel):
    ...
    # Price Intelligence: best rate found across ALL suppliers for this product,
    # and what buying from them instead would save on this suggested order.
    best_supplier_name: Optional[str] = None
    best_supplier_rate: Optional[float] = None
...
class SupplierPriceOut(SupplierPriceIn):
    id: str
    updated_at: datetime
