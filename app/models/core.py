...
class SupplierProductPrice(Base):
    """
    Price Intelligence source of truth: what each supplier quotes for a
    given product. This is what lets the AI manager say 'buy from B instead
    of A, save ₹X' — without this table there's nothing to compare against,
    since a Product only stores ONE purchase_price (whoever you last bought from).
    """
